...
class CelebADataset(Dataset):
    def __init__(self, root_path="data/celeba", mode="train", image_size=448, is_training=True):
        self.image_path = os.path.join(root_path, "images", "train")
        anno_path = os.path.join(root_path, "anno_pickle", "celeba_train.pkl")
        ...
        self.class_ids = list(range(1, 10178))
